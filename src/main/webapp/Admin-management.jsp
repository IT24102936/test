        ...
        <table>
          ...
          <%
            ...
            for (int i = 0; i < admins.size(); i++) {
              ...
              if (i == 0 && request.getParameter("editIndex") != null && Integer.parseInt(request.getParameter("editIndex")) == i) {
          %>
          <tr>
            <td><%= admin[0] %></td>
            <td><input type="text" value="<%= admin[1] %>" id="editName"></td>
            <td><input type="text" value="<%= admin[2] %>" id="editUsername"></td>
            <td><input type="email" value="<%= admin[3] %>" id="editEmail"></td>
            <td class="actions">
          ...
          <tr>
            ...
            <td class="actions">
              ...
              <% } else { %>
              <button class="edit-btn" onclick="editAdmin(<%= i %>)">Edit</button>
...
<script>
  ...
  function editAdmin(index) {
    window.location.href = "Admin-management.jsp?editIndex=" + index;
  }
